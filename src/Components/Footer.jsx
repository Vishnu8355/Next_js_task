        ...
        <footer>
                    ...
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 my-4 w-full xl:w-1/5">
                            ...
                            <p className="text-justify font-[poppins]">
                                Tailwind is a collection of UI Components created using Tailwind
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto">
                            <div>
                                <h2 className="inline-block font-[poppins] text-2xl pb-4 mb-4 border-b-4 border-blue-600">
                                    Company
                                </h2>
                            </div>
                            <ul className="leading-8">
                                <li>
                                    <a href="#" className="hover:text-blue-400 text-left">
                                        About Us
                                    </a>
                                </li>
                                <li>
                        ...
                        <div className="px-4 my-4 w-full sm:w-auto xl:w-1/5">
                            <div>
                                <h2 className="inline-block text-2xl font-[poppins] pb-4 mb-4 border-b-4 border-blue-600">
                                    Connect With Us
                                </h2>
                            </div>
                            <a
            ...
            <div className="bg-indigo-700 py-4 text-gray-100">
                <div className="container mx-auto px-4">
                    <div className="-mx-4 flex flex-wrap justify-between">
                        <div className="px-4 w-full font-[poppins] text-center sm:w-auto sm:text-left">
                            Copyright © 2023 - 2024. All Rights Reserved.
                        </div>
                        <div className="px-4 w-full font-[poppins] text-center sm:w-auto sm:text-left">
                            Made with ❤️ by Vishnu Tiwari.
                        </div>
                    </div>
                </div>
            </div>
